...
# dataset_name = "ILIDS"
# num_classes = 131
# image_dir = '../../dataset/iLIDS-VID/i-LIDS-VID/images/'
# pretrained_model = '../../model/feature_extraction/pretrained/resnet50_ilids.pth'
# # sequence_file = '../../dataset/iLIDS-VID/sequence_file/train001.txt'    # Train List
