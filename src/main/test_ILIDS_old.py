...
class Evaluator():
    ...
    def get_evaluation(self):
        ...
        R1, R5, R20 = octave.eval_func(self.output_features_path, nout=3)
        print("##########")
...
if __name__ == '__main__':
    ...
    pretrained_path = "../../work_dir/ILIDS/previous_Featex/model/best_model.pth"
    TestModel = torch.load(pretrained_path, map_location=cuda_device)
    TestModel.to(cuda_device)
    TestModel.eval()
    
    # Create evaluator
    evaluator = Evaluator(evaluation_path, TestModel, "ILIDS", "new_featex", 13, batch_size, n_features, n_class, n_frames, n_partitions, cuda_device)
