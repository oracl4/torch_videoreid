...
for epoch in range(0, n_epochs+1):
    ...
    if((epoch) % 10 == 0):
        ...
        TrainingModel.eval()
        with torch.no_grad():
            evaluator = test_ILIDS.Evaluator(evaluation_path, TrainingModel, dataset_name, experiment_name, epoch, batch_size, n_features, n_class, n_frames, n_partitions, cuda_device)
