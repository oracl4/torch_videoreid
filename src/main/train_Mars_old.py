...
# Local features path
localfeat2_path = '../../features/input/Mars/previous/train/train_split_2/'
localfeat4_path = '../../features/input/Mars/previous/train/train_split_4/'
...
for epoch in range(0, n_epochs+1):
    ...
    if((epoch) % 10 == 0):
        ...
        TrainingModel.eval()
        with torch.no_grad():
            evaluator = test_Mars_old.Evaluator(evaluation_path, TrainingModel, dataset_name, experiment_name, epoch, batch_size, n_features, n_class, n_frames, n_partitions, cuda_device)
