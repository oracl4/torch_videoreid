...
# feat_path = "/home/oracl4/work_dir/mahdi/scrf/videoreid/data/inputs/prid/featpart_prid/train_prid2/train01/00005.mat"

# Rizard Feature
old_feat_path = "/home/oracl4/work_dir/mahdi/torch_videoreid/features/input/ILIDS/previous/train/train_split_2/00000.mat"
old_feature = sio.loadmat(old_feat_path)['feat']
# old_feature = old_feature.flatten()
# old_feature = minmax_scale(old_feature)
# print(old_feature)

# New Feature
new_feat_path = "/home/oracl4/work_dir/mahdi/torch_videoreid/features/input/ILIDS/help/train/split_2/00001.mat"
new_feature = sio.loadmat(new_feat_path)['feat']
...
print("Rizard feature")
print(old_feat_path)
print("feat shape :", old_feature.shape)
print("feat average :", np.average(old_feature))
print("feat max :", np.max(old_feature))
print("feat min :", np.min(old_feature))

print()

print("New feature")
print(new_feat_path)
print("feat shape :", new_feature.shape)
print("feat average :", np.average(new_feature))
print("feat max :", np.max(new_feature))
print("feat min :", np.min(new_feature))

print()

feat_diff = new_feature - old_feature
print("feat diff :", np.average(feat_diff))
